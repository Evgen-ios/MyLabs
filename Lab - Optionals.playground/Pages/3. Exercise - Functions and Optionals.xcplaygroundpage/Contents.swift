...
func checkAge (string: String) -> Int? {
    if let posseblenumber = Int(string) {
        if posseblenumber > 18 {
            print("Добро пожаловать!")
            return posseblenumber
        } else {
...
func checProductInStock (name: String) -> Double! {
...
checProductInStock(name:"капуста")
