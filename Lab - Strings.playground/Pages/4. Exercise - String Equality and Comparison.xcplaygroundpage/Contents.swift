...
if nameInCaps.lowercased() == name.lowercased() {
    print("ЗАПИСАННОЕ СТРОЧНЫМИ БУКВАМИ \(nameInCaps) и ЗАПИСАННОЕ СТРОЧНЫМИ БУКВАМИ \(name) равны.")
} else {
    print("ЗАПИСАННОЕ СТРОЧНЫМИ БУКВАМИ \(nameInCaps) и ЗАПИСАННОЕ СТРОЧНЫМИ БУКВАМИ \(name) не равны.")
}
